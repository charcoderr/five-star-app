-- ─── Seed: Bread Meats Bread ─────────────────────────────────────────────────
-- Source: 5StarX Mystery Dine Report (Toby Sim, 27/01/26, 2 pax, phone booking)
--         File: "5StarX Mystery Dine Report - La Vita Feedback - July 2025.docx"
--
...
wipe as (
  delete from public.proformas where restaurant_id = 'aaaaaaaa-3333-4000-8000-000000000001' returning 1
)
insert into public.proformas (restaurant_id, title, questions, version)
select 'aaaaaaaa-3333-4000-8000-000000000001', 'Bread Meats Bread — Mystery Dine Report', questions, 1
...
where r.id = 'aaaaaaaa-3333-4000-8000-000000000001'
