...
export default function AdminLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="vouchers"    options={{ tabBarButton: () => null }} />
      <Tabs.Screen name="tcs-editor"  options={{ tabBarButton: () => null }} />
      <Tabs.Screen name="report"      options={{ tabBarButton: () => null }} />
      <Tabs.Screen name="restaurant"  options={{ tabBarButton: () => null }} />
    </Tabs>
  );
}
